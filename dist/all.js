...
var Life = function ($) {
    ...
    return {
        ...
        total: function total() {
            _this.gridSize.x * _this.gridSize.y;
        },
        ...
        */
        ...
        checkNeighbors: function checkNeighbors(x, y) {
        ...
        getDestiny: function getDestiny(neighborsCount, isAlive) {
            return neighborsCount === 3 || neighborsCount === 2 && isAlive ? LIVE : DIE;
        },
        isInsideTheXAxis: function isInsideTheXAxis(index) {
            return index > -1 && index <= this.gridSize.x;
        },
        isInsideTheYAxis: function isInsideTheYAxis(index) {
            return index > -1 && index <= this.gridSize.y;
        },
        isNeighbor: function isNeighbor(xAxis, yAxis, xAxisIndex, yAxisIndex) {
            return xAxisIndex === xAxis - 1 || xAxisIndex === xAxis + 1 || xAxisIndex === xAxis && yAxisIndex !== yAxis;
        },
        isNeighborAlive: function isNeighborAlive(x, y) {
            return this.rows[x] !== undefined && this.rows[x][y] !== undefined && this.rows[x][y] === LIVE;
        },
        updateRows: function updateRows(newRows) {
            this.rows = newRows;
        },
        /*
        ...
        */
        updateSurvivors: function updateSurvivors() {
        ...
        * Selects survivor
        */
        selectSurvivor: function selectSurvivor($this) {
        ...
        */
        updateSettings: function updateSettings(params) {
            if (params !== undefined) {
